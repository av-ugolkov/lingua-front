...
export default function WordCard({
  ...
  return (
      <>
        <div
            className='flex flex-row min-w-[540px] bg-blue-100 mb-8 border-solid border-[1px] border-gray-300 shadow-md shadow-blue-300'>
          ...
          {editable && (<div className='flex flex-col justify-around align-middle mx-2'>
            {word.id === '' ? (
